...
class TestDeployMicrocephApplicationStep(unittest.TestCase):
    def __init__(self, methodName: str = "runTest") -> None:
        super().__init__(methodName)
        self.client = patch("sunbeam.commands.microceph.Client")
...
class TestAddMicrocephUnitStep(unittest.TestCase):
    def __init__(self, methodName: str = "runTest") -> None:
        super().__init__(methodName)
    ...
    def test_is_skip(self):
        step = AddMicrocephUnitStep(self.name, self.jhelper)
        result = step.is_skip()
    ...
    def test_is_skip_application_missing(self):
        ...
        self.jhelper.get_application.assert_called_once()
        assert result.result_type == ResultType.FAILED
        assert result.message == "Microceph has not been deployed"
...
class TestRemoveMicrocephUnitStep(unittest.TestCase):
    def __init__(self, methodName: str = "runTest") -> None:
        super().__init__(methodName)
        self.clientMock = Mock()
        self.client = patch(
    ...
    def test_is_skip(self):
        ...
        step = RemoveMicrocephUnitStep(self.name, self.jhelper)
        result = step.is_skip()
